...
def commit(message=None):
    ...
    if "nothing to commit" not in items:
        ...
        # If a message has not been provided, prompt the user for one
        if message == None:
            message = input("Enter a message to go along with this commit: ")

        call(["git", "commit", "-m", message])
    else:
        print("Component does not need updated.")
...
"""
Adds an existing component from git.
"""
def add_component(url):
    print("Adding existing component to this project.")
    ...
    # os.mkdir("./components/" + component_name)
    os.chdir("./components/")

    clone(url)

    # call(["git", "subtree", "add", "--prefix", "./components/" + component_name, url, "master", "--squash"])
...
def create_component(url):
    ...
    initialize(git_init=True, url=url)

    # Push or initial changes to the server
